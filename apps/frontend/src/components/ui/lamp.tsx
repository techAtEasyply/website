  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 bg-gradient-to-br from-purple-200 to-purple-500 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
...
export const LampContainer = ({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-50 flex -translate-y-100 flex-col items-center ">
        {children}
      </div>
    </div>
  );
